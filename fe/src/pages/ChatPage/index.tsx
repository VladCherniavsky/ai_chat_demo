...
import { useChat } from '../../features/chat/index.ts'
import { selectLatestConversationId } from '../../features/chat/chatSelectors.ts'
import { ChatHeader } from '../../components/ChatHeader/index.tsx'
import { ChatWindow } from '../../components/ChatWindow/index.tsx'
    ...
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <div className="flex flex-1 flex-col min-w-0">
        ...
        <ChatWindow
          ...
          onSend={sendMessage}
          onJumpToCurrent={() => selectSession(latestConversationId)}
          autoFocus={activeConversationId === null && latestConversationId === null}
        />
      </div>
    </div>
  )
